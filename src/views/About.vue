...
<template>
  <div class="about-page">
    <div class="page-header">
      <h1>关于实践</h1>
      <div class="page-title-en">About</div>
      <p>了解津门寻脉小队的实践背景与团队成员</p>
    </div>
    ...
    <section class="section">
      <div class="floating-card animate-on-scroll">
        ...
        <div class="card-body">
          ...
          <br />
          <p>作为新中国第一所钢铁工业高等学府，北科大"因钢而生、依钢而兴"。1952年全国高校院系调整中，天津大学（原北洋大学）的冶金、采矿等相关学科整建制调入北京钢铁工业学院。本小队将奔赴天津大学，围绕矿冶学科发展脉络、院系调整划转细节、学术传承谱系等核心问题开展系统性溯源。</p>
          <br />
          <p>建校初期的亲历者已进入耄耋之年，"活历史"正面临消逝风险。本次实践旨在抢在记忆消散之前，抢救性挖掘口述史料与实物档案，填补院系调整细节与普通建设者故事的空白。实践成果将直接服务于雄安新校区校史馆的建设。</p>
        </div>
      </div>
    </section>
