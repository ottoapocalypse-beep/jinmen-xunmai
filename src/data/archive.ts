...
export const archiveItems: ArchiveItem[] = [
  ...
  // ══════════════════════════
  {
    ...
    category: 'person',
    date: '7.19已采访',
    description: '北京科技大学退休教授。已联系好，老师记性不大好。7月19日下午2:00-3:30在校史馆完成采访。采访纪实稿进行中（马立菲负责），推送制作待完成（王子衡负责）。',
    source: '津门寻脉实践团',
  },
  {
    id: 'arch-person-2',
    title: '曹国辉 教授',
    category: 'person',
    description: '北京科技大学退休教授。联系状态：不同意。爱人和自己都身体不好，已明确拒绝采访。',
    source: '津门寻脉实践团',
  },
  {
    id: 'arch-person-3',
    title: '余永宁 教授',
    category: 'person',
    description: '北京科技大学退休教授，国家级教学名师。联系状态：未联系上。座机已留言，手机关机。背景调查和采访稿撰写进行中（马立菲负责），联系进行中（孙凯迪负责）。',
    source: '津门寻脉实践团',
  },
  {
    id: 'arch-person-4',
    title: '周寿增 教授',
    category: 'person',
    description: '北京科技大学退休教授。联系状态：未联系上。座机没交费，手机关机。背景调查和采访稿撰写进行中（马立菲负责）。',
    source: '津门寻脉实践团',
  },
  {
    id: 'arch-person-5',
    ...
    category: 'person',
    date: '7.24下午3:30',
    description: '北京科技大学退休教授。已联系好。采访地点：51栋213号（到老师家去）。背景调查和采访稿撰写进行中（马立菲负责），联系已完成。',
    source: '津门寻脉实践团',
  },
  {
    id: 'arch-person-6',
    title: '李福燊 教授',
    category: 'person',
    date: '7.25下午3:00-5:00',
    description: '北京科技大学退休教授。住在燕园，郑老师联系过了（需询问郑老师）。背景调查和采访稿撰写进行中（马立菲负责）。',
    source: '津门寻脉实践团',
  },
  {
    id: 'arch-person-7',
    title: '刘庆国 教授',
    category: 'person',
    description: '北京科技大学退休教授。联系状态：未联系上。手机没人听，无座机。背景调查和采访稿撰写进行中（马立菲负责）。',
    source: '津门寻脉实践团',
  },
  {
    id: 'arch-person-8',
    title: '褚武扬 教授',
    category: 'person',
    description: '北京科技大学退休教授。联系状态：未联系上。座机已留言，电话没人接。背景调查和采访稿撰写进行中（马立菲负责）。',
    source: '津门寻脉实践团',
  },
  {
    id: 'arch-person-9',
    title: '王绪 教授',
    category: 'person',
    description: '北京科技大学退休教授。联系状态：未联系上。座机、手机都是空号。背景调查和采访稿撰写进行中（张寒婷负责）。',
    source: '津门寻脉实践团',
  },
  {
    id: 'arch-person-10',
    title: '贾成厂 教授',
    category: 'person',
    description: '北京科技大学退休教授。张美娜老师推荐，关工委那边也要采访，可以合作。关工委7月31日采访（需询问郑老师）。背景调查和采访稿撰写进行中（张寒婷负责）。',
    source: '津门寻脉实践团',
  },
  {
    id: 'arch-person-11',
    ...
    category: 'person',
    date: '7.23下午3:30',
    description: '北京科技大学材料科学与工程学科退休教授、博士生导师。曾任铸造教研室主任、铸造研究所所长。深耕金属凝固、激光表面改性方向。采访地点：51栋609号（到老师家去）。采访稿已完成（张寒婷负责），联系已完成（孙凯迪负责）。',
    source: '津门寻脉实践团',
  },
  {
    id: 'arch-person-12',
    title: '刘国权 教授',
    category: 'person',
    description: '北京科技大学退休教授。老师推荐了几本书，读过了再去找他联系。背景调查和采访稿撰写进行中（张寒婷负责）。',
    source: '津门寻脉实践团',
  },
  {
    id: 'arch-person-13',
    title: '柳得橹 教授',
    category: 'person',
    description: '北京科技大学退休教授。等材料学院那边联系。背景调查已完成（马立菲负责），采访稿撰写进行中（张寒婷负责）。',
    source: '津门寻脉实践团',
  },
  {
    id: 'arch-person-14',
  ...
  },
  {
    ...
    title: '肖纪美 院士',
    category: 'person',
    description: '北京科技大学金属物理方向知名学者，中国科学院院士。与王克智教授的材料成型工艺方向形成学科互补。',
    source: '百度百科',
  },
